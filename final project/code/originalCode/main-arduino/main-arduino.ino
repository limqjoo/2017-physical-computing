...
void loop()
{
  ...
  */
    ...
    if (receiving_array(1000) && received_array[1] > 64 && received_array[1] < 71) { //2 seconds, looped infinitely
      //if received array from docked diamond
      //get identity and current frequency of diamond
